...
typedef std::map<uint256, CCoinsByScript> CCoinsMapByScript; // uint160 = hash of script
...
public:
    ...
    static uint256 getKey(const CScript &script); // we use the hash of the script as key in the database
